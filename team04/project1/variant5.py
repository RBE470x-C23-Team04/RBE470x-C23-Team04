...
# killed_itself = 0
# killed_by_stupid = 0
# killed_by_aggressive = 0
# seed_killed = 0 #temp variable for killed by stupid
# seed_outcome = {}
...
#             seed_killed = i
#         if (str(g.events[event]) == "me was killed by aggressive"):
#             killed_by_aggressive = killed_by_aggressive + 1
...
# print("Me killed by stupid " + str(killed_by_stupid) + " time(s). Seed: " + str(seed_killed))
# print("Me killed by aggressive " + str(killed_by_aggressive) + " time(s).")
