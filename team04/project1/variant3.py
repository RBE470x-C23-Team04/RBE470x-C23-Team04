...
# Create the game
random.seed(892) # TODO Change this if you want different random choices
...
#         if (str(g.events[event]) == "me was killed by selfpreserving"):
#             killed_by_selfpreserving = killed_by_selfpreserving + 1
...
# print("Me killed by selfpreserving " + str(killed_by_selfpreserving) + " time(s).")
