...
class Game:
    ...
    def __init__(self, width, height, max_time, bomb_time, expl_duration, expl_range, sprite_dir="team04/project2/sprites/"):
        self.world = RealWorld.from_params(width, height, max_time, bomb_time, expl_duration, expl_range)
        self.sprite_dir = sprite_dir
        self.load_gui(width, height)

    @classmethod
    def fromfile(cls, fname, sprite_dir="team04/project2/sprites/"):
